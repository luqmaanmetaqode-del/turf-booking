  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', background: '#F8FAF7' }}>
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginTop: '2rem', paddingTop: '1.5rem', borderTop: '1px solid #EEF2E6' }}>
          <p style={{ color: '#98A2B3', fontSize: '0.95rem', fontWeight: '500' }}>
            Already registered?{' '}
            <Link to="/login" style={{ color: '#CEF17B', textDecoration: 'none', fontWeight: '700' }}>

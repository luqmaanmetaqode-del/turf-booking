    ...
    <div style={{ animation: 'fadeIn 0.5s ease-out' }}>
      ...
      <div style={{ background: 'white', padding: '2rem', borderRadius: '24px', border: '1.5px solid #EEF2E6' }}>
         ...
         <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '2rem' }}>
            {[
               { title: 'Change Password', sub: 'Update your password regularly', icon: <Lock size={20} />, color: '#CEF17B' },
              ...
              <div key={i} style={{ display: 'flex', gap: '1.5rem', alignItems: 'center', padding: '1.5rem', borderRadius: '20px', border: '1.5px solid #EEF2E6', cursor: 'pointer', transition: '0.2s' }}>
                 ...
                 <div style={{ flex: 1 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                       <span style={{ fontSize: '0.9rem', fontWeight: '800', color: '#161616' }}>{p.title}</span>
                       {p.badge && <span style={{ fontSize: '0.65rem', fontWeight: '800', background: '#DCEFB8', color: '#CEF17B', padding: '2px 8px', borderRadius: '6px' }}>{p.badge}</span>}
                    </div>
                    <p style={{ fontSize: '0.75rem', color: '#98A2B3', fontWeight: '500', marginTop: '4px' }}>{p.sub}</p>
                 </div>
